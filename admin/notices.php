...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['add_notice'])) {
       ...
       // $body = filter_input(INPUT_POST, 'body', FILTER_SANITIZE_STRING);
        //$body = filter_input(INPUT_POST, 'body', FILTER_UNSAFE_RAW, FILTER_FLAG_NO_ENCODE_QUOTES);
        $body = $_POST['body']; // Preserve raw HTML
        ...
        if (empty($date) || empty($headline) || empty($body)) {
            ...
            try {
                ...
                // Show full error details temporarily
                $_SESSION['error'] = "Database error: " . $e->getMessage();
                // Also log the exact query being executed
                error_log("Failed query: INSERT INTO notices VALUES ('$date', '$headline', '$body', '$type', '{$_SESSION['admin_user_id']}')");
            }
        }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    encoding: 'UTF-8',
    entity_encoding: 'raw', // This is crucial for preserving formatting
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex items-center space-x-4">
                <span class="text-sm text-gray-600">Logged in as: <strong> <?= htmlspecialchars($_SESSION['admin_username']) ?> </strong></span>
